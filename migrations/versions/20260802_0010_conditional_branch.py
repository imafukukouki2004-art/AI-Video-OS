...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        'fk_workflow_steps_next_true', 'workflow_steps', 'workflow_steps', 
        ['next_step_on_true'], ['id']
    )
    op.create_foreign_key(
        'fk_workflow_steps_next_false', 'workflow_steps', 'workflow_steps', 
        ['next_step_on_false'], ['id']
    )
