"""Alembic environment using the application PostgreSQL settings."""
...
from apps.api.publishing import models as publishing_models  # noqa: F401
...
async def run_migrations_online() -> None:
    """Apply migrations through SQLAlchemy's async psycopg engine."""
